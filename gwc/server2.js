...
var schema = buildSchema(`
    type Query {
        member(member_id: String!): Member
        members(current_party: String): [Member]
    },
...
/* Trying to put json data into var
var json = require('./memberListData.json');
const {membersListData} = json;
console.log(membersListData); // output 'testing'
*/

var getMember = function(args) {
    var member_id = args.member_id;
    return membersData.filter(member => {
        return member.member_id == member_id;
    })[0];
}

var getMembers = function(args) {
    if (args.last_name) {
        var last_name = args.last_name;
        return membersListData.filter(memberFromList => memberFromList.last_name === last_name);
    } else {
